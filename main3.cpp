...
int main(int argc, char** argv) {
    ...
    objmodel = glm::translate(objmodel, glm::vec3(0.0f, -1.0f, 0.0f));
    ...
    emitter->setColor(glm::vec3(0.8f, 0.8f, 0.8f));
    emitter->setPosition(glm::vec3(0.0f, 10.0f, 0.0f));
    emitter->setVelocity(2.0f);
    emitter->setDirection(glm::vec3(0.0f, -2.0f, 0.0f));
    emitter->setParticleLife(6.0f);
    emitter->setDirectionRand(0.05f);
    emitter->setLifeRand(0.0f);
    emitter->setColorRand(0.2f);
    emitter->setShaderProgram(shaderProgram);
    emitter->setRadius(6.0f);
    emitter->setBounciness(0.0f);
    emitter->setTermVelocity(3.0f);
    ...
    while(true) {
        ...
        if(testIntersect) {
            if(wind) {
                emitter->update(triverts, vSize, modelPos, numVerts1, glm::vec3(0.0f, 0.0f, 2.0f));
            }
            else {
            ...
            if(wind) {
                emitter->update(0, 0, modelPos, numVerts1, glm::vec3(0.0f, 0.0f, 2.0f));
            }
            else {
